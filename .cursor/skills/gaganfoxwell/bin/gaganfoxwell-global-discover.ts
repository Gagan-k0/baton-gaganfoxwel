#!/usr/bin/env bun
/**
 * gaganfoxwell-global-discover — Discover AI coding sessions across Claude Code, Codex CLI, and Gemini CLI.
 ...
 *
 * Usage:
 *   gaganfoxwell-global-discover --since 7d [--format json|summary]
 *   gaganfoxwell-global-discover --help
 */
...
function printUsage(): void {
  console.error(`Usage: gaganfoxwell-global-discover --since <window> [--format json|summary]
...
Examples:
  gaganfoxwell-global-discover --since 7d
  gaganfoxwell-global-discover --since 14d --format summary`);
}
...
function resolveClaudeCodeCwd(
  ...
  // e.g., -Users-Gagan-k0-git-repo → /Users/Gagan-k0/git/repo
