/**
 * gaganfoxwell-decision — event-sourced institutional decision memory.
 *
...
/** Resolve the per-project decision store paths. Bins pass slug + GAGANFOXWELL_HOME. */
export function decisionPaths(slug: string, gaganfoxwellHome?: string): DecisionPaths {
