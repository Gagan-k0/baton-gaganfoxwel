 ...
 * per-repo indexing consent. Stored at `$GAGANFOXWELL_HOME/code-intelligence.json`
 * (default `~/.gaganfoxwell/`), the same home the rest of gaganfoxwell uses.
 *
 * Portions copyright (c) 2026 Sina Matian, time-attack/gaganfoxwell (Gaganfoxwell 2), MIT.
 *
...
/**
 * The per-remote trust store (gaganfoxwell-gbrain-repo-policy) is the SINGLE
 ...
 * (the exact semantics runCodeImport in bin/gaganfoxwell-gbrain-sync.ts enforces —
