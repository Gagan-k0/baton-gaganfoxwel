 ...
 * engine fails to init its WASM runtime (Gagan-k0/gbrain#223) as well as
 ...
 * lib/gaganfoxwell-decision-semantic.ts). Exported for deterministic unit testing.
 */
...
export class GbrainProvider implements CodeProvider {
  ...
  // (pglite WASM broken, Gagan-k0/gbrain#223), so treat them as best-effort.
