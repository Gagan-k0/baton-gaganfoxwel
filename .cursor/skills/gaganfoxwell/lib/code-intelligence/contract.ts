 ...
 *
 * gaganfoxwell does not maintain a home-grown indexer. It defines this small contract
 ...
 * reliability contract as lib/gaganfoxwell-decision-semantic.ts.
 *
 ...
 * same semantics as runCodeImport in bin/gaganfoxwell-gbrain-sync.ts ("code ingest
...
export interface OpOptions {
   ...
   * CLI on PATH, temp GAGANFOXWELL_HOME). Matches the existing gbrain helpers.
   */
