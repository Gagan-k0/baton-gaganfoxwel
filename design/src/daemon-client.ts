...
export interface EnsureDaemonOptions {
   ...
   * DESIGN_DAEMON_STATE_FILE or .gaganfoxwell/design.json under the git root /
    ...
    if (health) {
      ...
      if (health.activeBoards > 0) {
        process.stderr.write(
          `[design-daemon] WARNING: existing daemon is gaganfoxwell ${health.version}; this CLI is ${expectedVersion}.\n` +
