 ...
 * file (.gaganfoxwell/design.json). Replaces the per-invocation server in
...
<meta charset="utf-8"><title>gaganfoxwell design boards</title><style>
...
<h1>gaganfoxwell design boards</h1>
...
function handleBoardGet(board: Board): Response {
  ...
  // No __GAGANFOXWELL_SERVER_URL injection — board JS uses relative URLs that
...
function boardExpiredHtml(id: string): string {
  return `<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><title>Board expired — gaganfoxwell</title>
