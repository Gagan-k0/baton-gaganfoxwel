#!/usr/bin/env bash
# Supabase project config for gaganfoxwell telemetry
...
GAGANFOXWELL_SUPABASE_URL="https://frugpmstpnojnhfyimgv.supabase.co"
GAGANFOXWELL_SUPABASE_ANON_KEY="sb_publishable_tR4i6cyMIrYTE3s6OyHGHw_ppx2p6WK"
