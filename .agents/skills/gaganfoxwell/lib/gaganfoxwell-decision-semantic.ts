/**
 * gaganfoxwell-decision-semantic — OPTIONAL gbrain enhancement for decision resurfacing.
 *
 * This is the ONLY decision module that touches gbrain. The reliable core
 * (lib/gaganfoxwell-decision.ts) has zero gbrain imports and works with gbrain OFF; this
 * module is loaded lazily by `gaganfoxwell-decision-search` only on `--semantic`, and every
 ...
 *  - The curated-memory source is the one whose local_path is the gaganfoxwell brain
 *    worktree (`~/.gaganfoxwell-brain-worktree`), id `default` by convention — NOT a
 *    `gaganfoxwell-brain-<user>` id. Scoping search to it keeps code/doc corpora out.
 */
...
const BRAIN_WORKTREE_SUFFIX = ".gaganfoxwell-brain-worktree";
...
/**
 * Resolve the curated-memory source id (the gaganfoxwell brain worktree). Returns null
