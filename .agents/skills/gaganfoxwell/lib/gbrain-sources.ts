 ...
 *
 * Mirrors the bash logic in bin/gaganfoxwell-gbrain-source-wireup:204-310 but in a form
 * importable by other TS callers (currently bin/gaganfoxwell-gbrain-sync.ts; future
...
import { withErrorContext } from "./gaganfoxwell-memory-helpers";
 ...
 * forensic logging to ~/.gaganfoxwell/.gbrain-errors.jsonl.
 */
 ...
 * gaganfoxwell-side gbrain call). `env` is the caller's base env (tests inject a
 * shim on PATH).
 */
