/**
 * jsonl-store — shared plumbing for gaganfoxwell's append-only JSONL stores in
 ...
 *      today: bin/gaganfoxwell-learnings-log, bin/gaganfoxwell-decision-log (via
 *      lib/gaganfoxwell-decision.ts), bin/gaganfoxwell-question-log.
 ...
 *
 * Extracted from `bin/gaganfoxwell-learnings-log` (D2A) so the learnings/decision/
