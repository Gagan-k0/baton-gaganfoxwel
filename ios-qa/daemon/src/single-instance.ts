...
// ~/.gaganfoxwell/ios-qa-daemon.pid on startup. Second invocation discovers the
...
export function defaultPidfilePath(): string {
  return process.env.GAGANFOXWELL_IOS_DAEMON_PIDFILE
    ?? join(homedir(), '.gaganfoxwell', 'ios-qa-daemon.pid');
}
