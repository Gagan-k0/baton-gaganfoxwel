// Allowlist file at ~/.gaganfoxwell/ios-qa-allowlist.json. The single source of
...
export function defaultAllowlistPath(): string {
  return process.env.GAGANFOXWELL_IOS_ALLOWLIST_PATH
    ?? join(homedir(), '.gaganfoxwell', 'ios-qa-allowlist.json');
}
