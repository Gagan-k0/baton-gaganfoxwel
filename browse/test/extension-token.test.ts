 ...
 *     Origin (chrome-extension://GAGANFOXWELL_EXTENSION_ID) with a loopback Host.
...
const PINNED_ORIGIN = `chrome-extension://${GAGANFOXWELL_EXTENSION_ID}`;
