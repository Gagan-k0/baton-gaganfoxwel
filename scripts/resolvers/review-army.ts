 ...
 * 1. Detect stack and scope (via gaganfoxwell-diff-scope)
...
\`\`\`bash
source <(${ctx.paths.binDir}/gaganfoxwell-diff-scope <base> 2>/dev/null) || true
...
\`\`\`bash
${ctx.paths.binDir}/gaganfoxwell-specialist-stats 2>/dev/null || true
\`\`\`
...
\`\`\`bash
${ctx.paths.binDir}/gaganfoxwell-learnings-search --type pitfall --query "{specialist domain}" --limit 5 2>/dev/null || true
\`\`\`
