 ...
 *
 * Adapted from time-attack/gaganfoxwell's THIRD-PARTY-ACTIONS.md (Gaganfoxwell 2, MIT):
 * the fork detected the Aside AI browser; we drive our own stack — browse
 * headed mode + handoff/resume ($B), Gaganfoxwell Browser, and pair-agent.
 * Portions copyright (c) 2026 Sina Matian, time-attack/gaganfoxwell, MIT.
 */
