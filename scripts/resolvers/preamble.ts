 ...
 *
 * Telemetry data flow:
 *   1. Always: local JSONL append to ~/.gaganfoxwell/analytics/ (inline, inspectable)
 *   2. If _TEL != "off" AND binary exists: gaganfoxwell-telemetry-log for remote reporting
 */
