 ...
 * under ~/.gaganfoxwell/projects/<slug>/, falling back to newest project-scoped
 ...
 * ~/.gaganfoxwell, and the committed copy is what teammates see — but a stale old
 ...
 * the prerequisite-skill re-check in review.ts (Gaganfoxwell 2 fork-port wave,
 * time-attack/gaganfoxwell). Drift between copies meant plan reviews could
 ...
 */
export const DESIGN_DOC_DISCOVERY_BLOCK = `_LOCALDOC=$(ls -t ~/.gaganfoxwell/projects/$SLUG/*-$BRANCH-design-*.md 2>/dev/null | head -1)
