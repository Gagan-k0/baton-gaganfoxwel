...
//   ~/.gaganfoxwell/.activated           — set at the end of the first-ever skill run
//   ~/.gaganfoxwell/.first-loop-tip-shown — set when the returning-session tip is shown
//
...
\`\`\`bash
${ctx.paths.binDir}/gaganfoxwell-telemetry-log --event-type first_task_scaffold_shown --skill "TASK_TOKEN" --outcome shown 2>/dev/null || true
