/**
 * Question Registry — typed schema for AskUserQuestion invocations across gaganfoxwell.
 *
 * Purpose
 * -------
 ...
 *
 * Not every AskUserQuestion in gaganfoxwell needs a registry entry right away. Skills
...
export interface QuestionDef {
  ...
  id: string;
  /** Skill that owns this question (must match a gaganfoxwell skill directory name) */
  skill: string;
...
export const QUESTIONS = {
  ...
  // -----------------------------------------------------------------------
  // /gaganfoxwell-upgrade — version upgrade
  // -----------------------------------------------------------------------
  'gaganfoxwell-upgrade-inline': {
    id: 'gaganfoxwell-upgrade-inline',
    skill: 'gaganfoxwell-upgrade',
    category: 'approval',
    door_type: 'two-way',
    options: ['yes-upgrade', 'always-auto', 'not-now', 'never-ask'],
    description: "Upgrade gaganfoxwell now? (Also: always auto-upgrade, snooze, or disable the prompt.)",
  },
  ...
  'preamble-telemetry-consent': {
    ...
    description: "Share usage data with gaganfoxwell? community (recommended) / anonymous / off",
  },
  'preamble-proactive-behavior': {
    ...
    door_type: 'two-way',
    options: ['on', 'off'],
    description: "Let gaganfoxwell proactively suggest skills based on conversation context?",
  },
  'preamble-routing-injection': {
    ...
    description: "Add gaganfoxwell skill routing rules to CLAUDE.md?",
  },
  'preamble-vendored-migration': {
    ...
    description: "This repo has vendored gaganfoxwell (deprecated) — migrate to team mode?",
  },
