 ...
 *   - bin/gaganfoxwell-brain-cache (drives TTL + write-back invalidation)
...
export interface BrainCacheEntity {
  /** Filename inside ~/.gaganfoxwell/{,projects/<slug>/}brain-cache/ */
  file: string;
   ...
   *   - 'skill-run-write'   — any skill that writes a gaganfoxwell/skill-run page
 ...
 * `gaganfoxwell-config set salience_allowlist '<comma-separated-prefixes>'`.
 */
...
/**
 * Retention policy: gaganfoxwell/skill-run pages auto-archive after this many days.
 ...
 */
export const GAGANFOXWELL_SCHEMA_PACK_NAME = 'gaganfoxwell-core';
export const GAGANFOXWELL_SCHEMA_PACK_VERSION = '1.0.0';
 ...
 * and persisted via `gaganfoxwell-config set user_slug_at_<endpoint-hash> <slug>`.
