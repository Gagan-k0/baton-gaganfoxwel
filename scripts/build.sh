...
"$BUN_CMD" build --compile bin/gaganfoxwell-global-discover.ts --outfile bin/gaganfoxwell-global-discover
bash browse/scripts/build-node-server.sh
bash scripts/write-version-files.sh browse/dist/.version design/dist/.version make-pdf/dist/.version
chmod +x browse/dist/browse browse/dist/find-browse design/dist/design make-pdf/dist/pdf bin/gaganfoxwell-global-discover
rm -f .*.bun-build
