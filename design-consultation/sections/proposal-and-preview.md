...
This phase generates visual previews of the proposed design system. Two paths depending on whether the gaganfoxwell designer is available.
...
_DESIGN_DIR="$HOME/.gaganfoxwell/projects/$SLUG/designs/design-system-$(date +%Y%m%d)"
mkdir -p "$_DESIGN_DIR"
