/**
 * gaganfoxwell browse — CSS Inspector content script
 *
...
(() => {
  ...
  if (window.__gaganfoxwellInspectorActive) return;
  window.__gaganfoxwellInspectorActive = true;
  ...
  function createHighlight() {
    ...
    highlightEl.id = 'gaganfoxwell-inspector-highlight';
    ...
    tooltipEl.id = 'gaganfoxwell-inspector-tooltip';
  ...
  function onMouseMove(e) {
    ...
    if (target.id === 'gaganfoxwell-inspector-highlight' || target.id === 'gaganfoxwell-inspector-tooltip') return;
  ...
  function injectCSS(id, css) {
    ...
    const styleId = `gaganfoxwell-inject-${id}`;
