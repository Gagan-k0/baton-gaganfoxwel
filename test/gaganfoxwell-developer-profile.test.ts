/**
 * bin/gaganfoxwell-developer-profile — subcommand behavior tests.
 *
 * Covers:
...
beforeEach(() => {
  tmpHome = fs.mkdtempSync(path.join(os.tmpdir(), 'gaganfoxwell-test-'));
});
...
describe('gaganfoxwell-developer-profile --read', () => {
...
describe('gaganfoxwell-developer-profile --migrate', () => {
...
describe('gaganfoxwell-developer-profile tier calculation', () => {
...
describe('gaganfoxwell-developer-profile --derive', () => {
...
describe('gaganfoxwell-developer-profile --trace <dim>', () => {
...
describe('gaganfoxwell-developer-profile --gap', () => {
...
describe('gaganfoxwell-developer-profile --vibe', () => {
...
describe('gaganfoxwell-developer-profile --check-mismatch', () => {
...
describe('gaganfoxwell-developer-profile errors', () => {
...
describe('gaganfoxwell-developer-profile --log-session (#1671 fix)', () => {
  ...
  test('silently skips invalid JSON input (matches gaganfoxwell-timeline-log pattern)', () => {
...
describe('gaganfoxwell-developer-profile resources entries do not inflate count/tier/nudge', () => {
