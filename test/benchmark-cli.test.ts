/**
 * gaganfoxwell-model-benchmark CLI tests (offline).
 *
...
const BIN = path.join(ROOT, 'bin', 'gaganfoxwell-model-benchmark');
...
describe('gaganfoxwell-model-benchmark prompt resolution', () => {
