...
const PLAN_ENG_5_FINDINGS = [
  'Please review this plan thoroughly. As you go, write your plan-mode plan to /tmp/gaganfoxwell-test-plan-eng.md (use Edit/Write to that exact path).',
  '',
...
const PLAN_ENG_PATH = '/tmp/gaganfoxwell-test-plan-eng.md';
