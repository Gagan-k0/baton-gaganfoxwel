 ...
 *
 * Default capacity 3. Override via GAGANFOXWELL_SDK_MAX_CONCURRENCY env var.
 */
class Semaphore {
...
const DEFAULT_SDK_CONCURRENCY = Number(process.env.GAGANFOXWELL_SDK_MAX_CONCURRENCY ?? 3);
...
export async function runAgentSdkTest(
  ...
  // scrub + ANTHROPIC_API_KEY + hermetic CLAUDE_CONFIG_DIR/GAGANFOXWELL_HOME), with
