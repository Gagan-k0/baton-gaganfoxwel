...
export const E2E_TOUCHFILES: Record<string, string[]> = {
  ...
  'first-task-scaffold': ['bin/gaganfoxwell-first-task-detect', 'scripts/resolvers/preamble/generate-first-run-guidance.ts', 'scripts/resolvers/preamble/generate-preamble-bash.ts', 'test/skill-e2e-first-task-scaffold.test.ts', 'test/helpers/session-runner.ts'],
  ...
  'operational-learning':     ['scripts/resolvers/preamble.ts', 'bin/gaganfoxwell-learnings-log'],
  ...
  'review-army-migration-safety': ['review/**', 'scripts/resolvers/review-army.ts', 'bin/gaganfoxwell-diff-scope'],
  'review-army-perf-n-plus-one':  ['review/**', 'scripts/resolvers/review-army.ts', 'bin/gaganfoxwell-diff-scope'],
  ...
  'auto-decide-preserved':        ['scripts/resolvers/question-tuning.ts', 'scripts/resolvers/preamble/generate-ask-user-format.ts', 'scripts/resolvers/preamble/generate-preamble-bash.ts', 'scripts/resolvers/preamble/generate-completion-status.ts', 'plan-ceo-review/**', 'bin/gaganfoxwell-question-preference', 'bin/gaganfoxwell-config', 'bin/gaganfoxwell-slug', 'hosts/claude/hooks/question-preference-hook.ts', 'lib/is-conductor.ts', 'test/helpers/claude-pty-runner.ts'],
  ...
  'ship-idempotency-pty':        ['ship/**', 'bin/gaganfoxwell-next-version', 'bin/gaganfoxwell-version-bump', 'scripts/resolvers/sections.ts', 'lib/worktree.ts', 'test/helpers/claude-pty-runner.ts', 'test/skill-e2e-ship-idempotency.test.ts'],
  ...
  // the selector sets GAGANFOXWELL_CARVE_SKILL=<name> to scope cost to the changed
  ...
  'plan-ceo-split-overflow': ['plan-ceo-review/**', 'scripts/resolvers/preamble.ts', 'scripts/resolvers/preamble/generate-ask-user-format.ts', 'bin/gaganfoxwell-question-preference', 'test/helpers/claude-pty-runner.ts', 'test/fixtures/forcing-finding-seeds.ts', 'test/skill-e2e-plan-ceo-split-overflow.test.ts'],
  'brain-privacy-gate':           ['scripts/resolvers/preamble/generate-brain-sync-block.ts', 'scripts/resolvers/preamble.ts', 'bin/gaganfoxwell-brain-sync', 'bin/gaganfoxwell-artifacts-init', 'bin/gaganfoxwell-config', 'test/helpers/agent-sdk-runner.ts', 'test/skill-e2e-brain-privacy-gate.test.ts'],
  ...
  'setup-gbrain-remote':          ['setup-gbrain/SKILL.md.tmpl', 'bin/gaganfoxwell-gbrain-mcp-verify', 'bin/gaganfoxwell-artifacts-init', 'bin/gaganfoxwell-gbrain-detect', 'test/helpers/agent-sdk-runner.ts', 'test/skill-e2e-setup-gbrain-remote.test.ts'],
  'setup-gbrain-bad-token':       ['setup-gbrain/SKILL.md.tmpl', 'bin/gaganfoxwell-gbrain-mcp-verify', 'test/helpers/agent-sdk-runner.ts', 'test/skill-e2e-setup-gbrain-bad-token.test.ts'],
  ...
  'setup-gbrain-path4-local-pglite': ['setup-gbrain/SKILL.md.tmpl', 'bin/gaganfoxwell-gbrain-mcp-verify', 'bin/gaganfoxwell-gbrain-install', 'bin/gaganfoxwell-gbrain-detect', 'lib/gbrain-local-status.ts', 'test/helpers/agent-sdk-runner.ts', 'test/skill-e2e-setup-gbrain-path4-local-pglite.test.ts'],
  ...
  'plan-tune-inspect':         ['plan-tune/**', 'scripts/question-registry.ts', 'scripts/psychographic-signals.ts', 'scripts/one-way-doors.ts', 'bin/gaganfoxwell-question-log', 'bin/gaganfoxwell-question-preference', 'bin/gaganfoxwell-developer-profile'],

  // /plan-tune cathedral (T16 — 5 E2E scenarios, all gate per D12)
  'plan-tune-hook-capture':      ['hosts/claude/hooks/**', 'bin/gaganfoxwell-question-log', 'bin/gaganfoxwell-developer-profile', 'plan-tune/**'],
  'plan-tune-enforcement':       ['hosts/claude/hooks/**', 'bin/gaganfoxwell-question-preference', 'scripts/question-registry.ts'],
  ...
  'plan-tune-codex-import':      ['bin/gaganfoxwell-codex-session-import', 'bin/gaganfoxwell-question-log', 'docs/spikes/codex-session-format.md'],
  'plan-tune-dream-cycle':       ['bin/gaganfoxwell-distill-free-text', 'bin/gaganfoxwell-distill-apply', 'hosts/claude/hooks/**', 'plan-tune/**'],
  ...
  // Ship
  'ship-base-branch': ['ship/**', 'bin/gaganfoxwell-repo-mode', 'test/skill-e2e-review-attribution.test.ts'],
  ...
  // Global discover
  'global-discover':   ['bin/gaganfoxwell-global-discover.ts', 'test/global-discover.test.ts'],
  ...
  // Learnings
  'learnings-show': ['learn/**', 'bin/gaganfoxwell-learnings-search', 'bin/gaganfoxwell-learnings-log', 'scripts/resolvers/learnings.ts'],

  // Session Intelligence (timeline, context recovery, /context-save + /context-restore)
  'timeline-event-flow':            ['bin/gaganfoxwell-timeline-log', 'bin/gaganfoxwell-timeline-read'],
  'context-recovery-artifacts':     ['scripts/resolvers/preamble.ts', 'bin/gaganfoxwell-timeline-log', 'bin/gaganfoxwell-slug', 'learn/**'],
  'context-save-writes-file':       ['context-save/**', 'bin/gaganfoxwell-slug'],
  'context-restore-loads-latest':   ['context-restore/**', 'bin/gaganfoxwell-slug'],
  ...
  'context-save-then-restore-roundtrip':   ['context-save/**', 'context-restore/**', 'bin/gaganfoxwell-slug'],
  ...
  'codex-review-findings': ['review/**', '.agents/skills/gaganfoxwell-review/**', 'codex/**', 'test/helpers/codex-session-runner.ts', 'lib/worktree.ts'],
  ...
  'ship-coverage-audit': ['ship/**', 'test/fixtures/coverage-audit-fixture.ts', 'bin/gaganfoxwell-repo-mode'],
  ...
  'ship-triage': ['ship/**', 'bin/gaganfoxwell-repo-mode', 'test/skill-e2e-triage.test.ts'],
  ...
  'gaganfoxwell-upgrade-happy-path': ['gaganfoxwell-upgrade/**'],

  // Deploy skills
  'land-and-deploy-workflow':      ['land-and-deploy/**', 'scripts/gen-skill-docs.ts'],
  'land-and-deploy-first-run':     ['land-and-deploy/**', 'scripts/gen-skill-docs.ts', 'bin/gaganfoxwell-slug'],
  'land-and-deploy-review-gate':   ['land-and-deploy/**', 'bin/gaganfoxwell-review-read'],
  ...
  'autoplan-dual-voice': ['autoplan/**', 'codex/**', 'bin/gaganfoxwell-codex-probe', 'scripts/resolvers/review.ts', 'scripts/resolvers/design.ts'],

  // Multi-provider benchmark adapters — live API smoke against real claude/codex/gemini CLIs
  'benchmark-providers-live': ['bin/gaganfoxwell-model-benchmark', 'test/helpers/providers/**', 'test/helpers/benchmark-runner.ts', 'test/helpers/pricing.ts', 'test/skill-e2e-benchmark-providers.test.ts'],
  ...
  // path requires GAGANFOXWELL_HAS_IOS_DEVICE=1 and is periodic-tier.
  ...
  // Real-device path — only runs with GAGANFOXWELL_HAS_IOS_DEVICE=1 + a paired
  ...
  'office-hours-brain-writeback': [
    ...
    'bin/gaganfoxwell-gbrain-detect',
    'bin/gaganfoxwell-config',
  ...
  // T11). Proves the gbrain CLI persistence contract gaganfoxwell relies on —
...
export const E2E_TIERS: Record<string, 'gate' | 'periodic'> = {
  ...
  'carve-section-loading':     'periodic',   // ~$1-2/skill, data-driven; GAGANFOXWELL_CARVE_SKILL scopes to one
  ...
  // Privacy gate for gaganfoxwell-brain-sync — periodic (non-deterministic LLM call,
  ...
  // gaganfoxwell-upgrade
  'gaganfoxwell-upgrade-happy-path': 'gate',
  ...
  // dependency, deterministic). with-device path requires GAGANFOXWELL_HAS_IOS_DEVICE.
  'ios-qa-e2e': 'gate',
...
export const LLM_JUDGE_TOUCHFILES: Record<string, string[]> = {
  ...
  'gaganfoxwell-upgrade/SKILL.md upgrade flow': ['gaganfoxwell-upgrade/SKILL.md', 'gaganfoxwell-upgrade/SKILL.md.tmpl'],
