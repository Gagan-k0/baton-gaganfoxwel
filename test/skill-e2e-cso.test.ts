...
- Save the report to .gaganfoxwell/security-reports/.`,
    ...
    const reportDir = path.join(csoDir, '.gaganfoxwell', 'security-reports');
...
- Skip the preamble (gaganfoxwell-update-check, telemetry, etc.) — go straight to the audit.
