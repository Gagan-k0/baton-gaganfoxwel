...
const OPENCLAW_NATIVE_SKILLS = [
  'openclaw/skills/gaganfoxwell-openclaw-investigate/SKILL.md',
  'openclaw/skills/gaganfoxwell-openclaw-office-hours/SKILL.md',
  'openclaw/skills/gaganfoxwell-openclaw-ceo-review/SKILL.md',
  'openclaw/skills/gaganfoxwell-openclaw-retro/SKILL.md',
];
