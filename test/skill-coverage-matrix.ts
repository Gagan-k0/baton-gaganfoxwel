 ...
 *
 * Single source of truth mapping each gaganfoxwell skill to its E2E test files.
...
export const SKILL_COVERAGE: Record<string, SkillCoverage> = {
  ...
  'gaganfoxwell-upgrade': { gate: ['test/skill-coverage-floor.test.ts'], periodic: [] },
  ...
  'open-gaganfoxwell-browser': { gate: ['test/skill-coverage-floor.test.ts'], periodic: [] },
