 ...
 *  ~/.claude/skills/ is unsafe: it may contain symlinks from the real gaganfoxwell
...
function installSkills(tmpDir: string) {
  const skillDirs = [
    ...
    'gaganfoxwell-upgrade', 'humanizer',
  ];
  ...
  for (const skill of skillDirs) {
    ...
    const skillName = skill || 'gaganfoxwell';
