/**
 * gaganfoxwell-gbrain-supabase-verify + gaganfoxwell-gbrain-lib.sh — Slice 3 of /setup-gbrain.
 *
 ...
 * skill template and by gaganfoxwell-gbrain-supabase-provision. Validates var
...
const VERIFY = path.join(ROOT, 'bin', 'gaganfoxwell-gbrain-supabase-verify');
...
describe('gaganfoxwell-gbrain-supabase-verify', () => {
  const VALID =
...
describe('gaganfoxwell-gbrain-lib.sh read_secret_to_env', () => {
