/**
 * gaganfoxwell-gbrain-mcp-verify — error-classification tests with a mocked curl.
 *
...
const VERIFY_BIN = path.join(ROOT, 'bin', 'gaganfoxwell-gbrain-mcp-verify');
...
beforeEach(() => {
  tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), 'gaganfoxwell-mcp-verify-test-'));
...
describe('gaganfoxwell-gbrain-mcp-verify', () => {
