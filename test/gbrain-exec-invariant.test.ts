 ...
 * `bin/gaganfoxwell-gbrain-sync.ts` or `bin/gaganfoxwell-memory-ingest.ts` silently
 ...
 * `lib/gaganfoxwell-memory-helpers.ts`, `bin/gaganfoxwell-brain-context-load.ts`)
