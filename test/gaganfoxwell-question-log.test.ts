/**
 * bin/gaganfoxwell-question-log — schema validation + injection defense tests.
 */
...
const BIN = path.join(ROOT, 'bin', 'gaganfoxwell-question-log');
...
describe('gaganfoxwell-question-log — valid payloads', () => {
...
describe('gaganfoxwell-question-log — rejected payloads', () => {
...
describe('gaganfoxwell-question-log — injection defense', () => {
  const attacks = [
...
describe('gaganfoxwell-question-log — shared injection patterns (#1934 dedup)', () => {
