/**
 * Contract tests for bin/gaganfoxwell-redact — exit codes, JSON shape, flags,
...
const BIN = path.resolve(import.meta.dir, "..", "bin", "gaganfoxwell-redact");
...
describe("gaganfoxwell-redact exit codes", () => {
  test("clean → 0", () => {
...
describe("gaganfoxwell-redact --json", () => {
...
describe("gaganfoxwell-redact --auto-redact", () => {
...
describe("gaganfoxwell-redact --allowlist", () => {
...
describe("gaganfoxwell-redact --self-email", () => {
...
describe("gaganfoxwell-redact --from-file", () => {
...
describe("gaganfoxwell-redact oversize fails closed", () => {
...
describe("gaganfoxwell-redact argv dispatch", () => {
  ...
  // "scan" is what the human output header ("gaganfoxwell-redact scan — repo …")
