 ...
 * (~/.gaganfoxwell/projects/<slug>/evals/) and compares the latest run against
 * its predecessor.
 *
 ...
 *
 * Override: GAGANFOXWELL_BUDGET_RATIO=<n> (default 2.0).
 *
 ...
 *                                   ~/.gaganfoxwell/analytics/spend-overrides.jsonl
 *
