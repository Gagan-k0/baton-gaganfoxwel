...
const STABLE_HOST_ALL_OUTPUTS = [
  'SKILL.md',
  'ship/SKILL.md',
  '.agents/skills/gaganfoxwell-ship/SKILL.md',
  '.cursor/skills/gaganfoxwell-ship/SKILL.md',
  '.factory/skills/gaganfoxwell-ship/SKILL.md',
  '.gbrain/skills/gaganfoxwell-ship/SKILL.md',
];
