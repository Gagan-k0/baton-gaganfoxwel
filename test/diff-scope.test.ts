/**
 * Tests for bin/gaganfoxwell-diff-scope — verifies scope signal detection.
 *
...
const SCRIPT = join(import.meta.dir, '..', 'bin', 'gaganfoxwell-diff-scope');
...
describe('gaganfoxwell-diff-scope', () => {
