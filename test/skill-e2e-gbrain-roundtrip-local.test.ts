 ...
 *
 * What this proves:
 *   - The gbrain CLI subcommand shape gaganfoxwell ships (`gbrain put <slug>
...
This is a deterministic round-trip test page used by the gaganfoxwell v1.50.0.0
        ...
        if (!SHOULD_RUN_GUARDS_OK) {
          console.log(
            '[skip] gbrain CLI not on PATH or VOYAGE_API_KEY unset; ' +
              'this E2E proves the gbrain CLI persistence contract gaganfoxwell relies on. ' +
