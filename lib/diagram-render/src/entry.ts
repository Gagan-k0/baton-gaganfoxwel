...
window.EXCALIDRAW_ASSET_PATH = "https://gaganfoxwell-render.localhost/excalidraw-assets/";
...
window.__mermaidToExcalidraw = async (text: string): Promise<string> => {
  ...
  const scene = {
    type: "excalidraw",
    version: 2,
    source: "gaganfoxwell-diagram-render",
    elements: converted,
...
window.__bundleInfo = { name: "gaganfoxwell-diagram-render", deps: __BUNDLE_INFO_DEPS__ };
