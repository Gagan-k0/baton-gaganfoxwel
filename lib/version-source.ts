...
//
// gaganfoxwell's native shape is a plain-text VERSION file at the repo root holding a
// 4-digit MAJOR.MINOR.PATCH.MICRO — and for gaganfoxwell itself that file STAYS the
...
//      build injects it). The --version-path / .gaganfoxwell/version-path pin already
...
//      components, so gaganfoxwell-next-version exited 2 ("could not parse base
...
/**
 * The npm-valid form of a gaganfoxwell version. npm's semver is 3-component and
