## Coding Tasks (gaganfoxwell)

### Rules (non-negotiable)

1. **Always spawn, never redirect.** When user asks to use ANY gaganfoxwell skill,
...
→ sessions_spawn(runtime: "acp", prompt: "<gaganfoxwell-lite content>\n\n<task>")

**HEAVY:** needs a specific gaganfoxwell methodology
→ sessions_spawn(runtime: "acp", prompt: "Load gaganfoxwell. Run /qa https://...")
  Skills: /cso, /review, /qa, /ship, /investigate, /design-review, /benchmark, /gaganfoxwell-upgrade

**FULL:** build a complete feature, multi-day scope, needs planning + review
→ sessions_spawn(runtime: "acp", prompt: "<gaganfoxwell-full content>\n\n<task>")
...
→ sessions_spawn(runtime: "acp", prompt: "<gaganfoxwell-plan content>\n\n<task>")
...
- "Upgrade gaganfoxwell", "update gaganfoxwell" → **HEAVY** with `Run /gaganfoxwell-upgrade`
