...
When Claude controls your real browser via CDP (gaganfoxwell `$B connect`), you look at two
windows: **Conductor** (to see Claude's thinking) and **Chrome** (to see Claude's actions).

gaganfoxwell's Chrome extension Side Panel shows browse activity — every command, result,
...
A "Session" tab in the gaganfoxwell Chrome extension Side Panel that shows:
  ...
  "workspaces": [
    {
      ...
      "directory": "/Users/garry/gaganfoxwell",
      "pid": 12345,
      "active": true
    }
  ]
...
## What gaganfoxwell builds (extension side)
