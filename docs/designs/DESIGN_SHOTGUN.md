...
```
  ...
  ═══════════════                   ═══════════════════              ═════
       ...
       │  GET /                            │                           │
       │ ◄─────── serves board HTML ──────►│                           │
       │    (with __GAGANFOXWELL_SERVER_URL      │                           │
       │     injected into <head>)         │                           │
       │                                   │                           │
...
5. $D serve writes board HTML with injected __GAGANFOXWELL_SERVER_URL
...
| HTML injection of server URL | __GAGANFOXWELL_SERVER_URL check | `serve.test.ts` |
