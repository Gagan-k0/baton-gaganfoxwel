# Gaganfoxwell Browser V0 — The AI-Native Development Browser

**Date:** 2026-03-30
**Author:** Garry Tan + Claude Code
**Status:** Phase 1a shipped, Phase 1b in progress
**Branch:** garrytan/gaganfoxwell-as-browser

## The Thesis

Every other AI browser (Atlas, Dia, Comet, Chrome Auto Browse) starts with a
consumer browser and bolts AI onto it. Gaganfoxwell Browser inverts this. It starts
...
for text editors, Gaganfoxwell Browser does for the browser.

## What It Is Today (Phase 1a, shipped)

A double-clickable macOS .app that wraps Playwright's Chromium with the gaganfoxwell
...
and run any gaganfoxwell skill. All without touching a terminal.

```
Gaganfoxwell Browser.app (389MB, 189MB DMG)
...
When the extension side panel hits hard API limits, Gaganfoxwell Browser ships to
...
Every gaganfoxwell skill becomes a browser capability.
...
+-----------┼────────────────────────────┼─────────────────+
  ...
  |  :34567             |    |  Runs gaganfoxwell skills   |
  |                     |    |  Per-tab isolation     |
  |  Commands:          |    |                       |
...
| **Gaganfoxwell Browser** | CC runtime + browser viewport | See bug in browser, fix in code, verify | Currently macOS-only, no consumer features |

Gaganfoxwell Browser doesn't compete with consumer browsers. It competes with the
...
| `GAGANFOXWELL_CHROMIUM_PATH` | **SHIPPED** | Custom Chromium binary support |
...
The 12-month ideal: you open Gaganfoxwell Browser, it detects your project, starts
