...
- gaganfoxwell installed (`./setup` complete; verify with `which gaganfoxwell` or by typing `/` in Claude Code and seeing skills listed)
...
- **Why gaganfoxwell uses the Diataxis framework:** [explanation-diataxis-in-gaganfoxwell.md](./explanation-diataxis-in-gaganfoxwell.md)
