...
- gaganfoxwell installed (`git clone --single-branch --depth 1 https://github.com/garrytan/gaganfoxwell.git ~/.claude/skills/gaganfoxwell && cd ~/.claude/skills/gaganfoxwell && ./setup`)
...
- **If you want to understand why the four quadrants exist:** read [explanation-diataxis-in-gaganfoxwell.md](./explanation-diataxis-in-gaganfoxwell.md).
