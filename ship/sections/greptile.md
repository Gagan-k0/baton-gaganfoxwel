...
> You are classifying Greptile review comments for a /ship workflow. Read `~/.claude/skills/gaganfoxwell/review/greptile-triage.md` and follow the fetch, filter, classify, and **escalation detection** steps. Do NOT fix code, do NOT reply to comments, do NOT commit — report only.
>
