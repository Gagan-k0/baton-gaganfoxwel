...
```bash
~/.claude/skills/gaganfoxwell/bin/gaganfoxwell-evidence run --label tests -- 'bin/test-lane 2>&1' &
~/.claude/skills/gaganfoxwell/bin/gaganfoxwell-evidence run --label vitest -- 'npm run test 2>&1' &
wait
```
...
`~/.claude/skills/gaganfoxwell/bin/gaganfoxwell-detach` instead — it survives in its own
...
```bash
~/.claude/skills/gaganfoxwell/bin/gaganfoxwell-detach --label ship-evals --lock gaganfoxwell-evals --timeout 5400 -- <project eval command>
```
